...
def train_contrast_model():
    ...
    # 训练数据文件夹（需根据实际路径修改）
    contrast_folders = [
        r"E:\学校\科研项目\tmall_springboot\data_fig\experiment_fig\skyrmion",
        r"E:\学校\科研项目\tmall_springboot\data_fig\experiment_fig\vortex"
    ]
...
if __name__ == '__main__':
    ...
    xy_folder = r"E:\学校\科研项目\tmall_springboot\data_fig\XY_label_fig"
    xz_folder = r"E:\学校\科研项目\tmall_springboot\data_fig\XZ_label_fig"
    xyz_folder = r"E:\学校\科研项目\tmall_springboot\data_fig\XYZ_label_fig"
